...
public class SliderLayout extends RelativeLayout{
    ...
    public void setmAutoCycle(boolean mAutoCycle) {
        this.mAutoCycle = mAutoCycle;
    }
    ...
    public enum Transformer{
        Default("Default"),//默认平滑
        Accordion("Accordion"),//手风琴
        Background2Foreground("Background2Foreground"),//从后向前
        CubeIn("CubeIn"),//立方
        DepthPage("DepthPage"),//深度
        Fade("Fade"),//淡出
        FlipHorizontal("FlipHorizontal"),//水平翻转
        FlipPage("FlipPage"),//翻页
        Foreground2Background("Foreground2Background"),//从前到后
        RotateDown("RotateDown"),//向下旋转
        RotateUp("RotateUp"),//向上旋转
        Stack("Stack"),//栈效果
        Tablet("Tablet"),//桌台效果
        ZoomIn("ZoomIn"),//缩小
        ZoomOutSlide("ZoomOutSlide"),//缩小幻灯片
        ZoomOut("ZoomOut");//放大
